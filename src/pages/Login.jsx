...
const Login = () => {
    ...
    return (
        ...
        <section className="pb-16">
            <div data-aos="fade-right" data-aos-anchor=".other-element" className="w-full mx-auto sm:max-w-sm max-w-[90%] p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100">
                <h1 className="text-2xl font-bold text-center">Login</h1>
                <form noValidate="" action="" className="space-y-6" onSubmit={handleLogIn}>
                    <div className="space-y-1 text-sm">
                        <label className="block text-gray-400">Email</label>
                        <input type="email" name="email" id="email" placeholder="Enter Your Email" className="w-full px-4 py-3 rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-violet-400" />
                    </div>
                    <div className="space-y-1 text-sm">
                ...
                <p className="text-xs text-center sm:px-6 text-gray-400">Don't have an account?
                    <NavLink to="/register" rel="noopener noreferrer" href="#" className="underline text-gray-100">Sign up</NavLink>
                </p>
            </div>
        </section>
    )
